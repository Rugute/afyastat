...
#sudo docker start medic-os
#sudo docker medic-os:/boot/svc-restart medic-core nginx
...
medic-conf --url=http://medic:cb6f4d4b-73cc-4c42-97cb-0db5a631190a@localhost:5988 upload-app-settings delete-all-forms upload-app-forms upload-contact-forms upload-resources upload-custom-translations --accept-self-signed-certs
